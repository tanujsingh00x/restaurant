...
const Footer = () => {
  return (
    <footer
      className="bg-orange-100 dark:bg-[#1F1D2B] text-black dark:text-white pt-16 pb-10 px-6 lg:px-20 transition-colors duration-300"
      id="contact"
    >
      ...
      <div className="text-center text-sm text-gray-500 border-t mt-4 pt-4">
        @copyright developed by Tanuj Singh | All rights reserved
      </div>
    </footer>
  );
};
