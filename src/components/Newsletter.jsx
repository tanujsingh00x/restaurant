      ...
      <div className="bg-orange-100 dark:bg-[#1F1D2B] py-16 px-6 lg:px-20 mx-4 lg:mx-16 rounded-3xl">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-6">
            Subscribe to our newsletter and never miss any update or special
            offer!
          </p>
          ...
          <form className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <button
              type="submit"
              className="cursor-pointer bg-orange-500 hover:bg-orange-600 text-white font-medium px-6 py-3 rounded-full transition"
            >
              Subscribe
            </button>
          </form>
